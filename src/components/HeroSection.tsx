  ...
  return (
    <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto text-center">
        ...
        <p className="text-gray-600 mb-8">Top-Qualität. Sofortige Lieferung. Lebenslange Garantie.</p>
        
        {/* Social Media Icons */}
        <div className="flex justify-center gap-4 mb-12">
          <div className="w-12 h-12 border border-pink-400 bg-gradient-to-br from-pink-500 to-orange-400 rounded-lg flex items-center justify-center">
          ...
          <div className="w-12 h-12 border border-gray-300 bg-gray-200 rounded-lg flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500">
              <path d="M9 12 11 14 15 10" />
              <path d="M21 8v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V8a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5Z" />
            </svg>
          </div>
          <div className="w-12 h-12 border border-red-300 bg-red-100 rounded-lg flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-red-500">
              <path d="m22 8-6 4 6 4V8Z" />
              <rect x="2" y="6" width="14" height="12" rx="2" />
            </svg>
          </div>
          <div className="w-12 h-12 border border-blue-300 bg-blue-100 rounded-lg flex items-center justify-center">
        ...
        <div className="max-w-md mx-auto space-y-4">
          <button className="service-button group">
